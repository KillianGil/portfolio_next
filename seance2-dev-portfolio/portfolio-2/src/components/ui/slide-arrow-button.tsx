...
export default function SlideArrowButton({
  ...
  return (
    <button
      className={`group relative rounded-full border border-white bg-white p-2 text-xl ${className}`}
      {...props}
    >
      <div
      ...
      <span className="relative left-4 z-10 whitespace-nowrap px-8 font-medium text-black transition-all duration-200 ease-in-out group-hover:-left-3 group-hover:text-white">
  {text}
</span>
    </button>
  );
